...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#6366F1', 'primaryTextColor': '#FFFFFF', 'primaryBorderColor': '#4F46E5', 'secondaryColor': '#A78BFA', 'secondaryTextColor': '#1A1A2E', 'tertiaryColor': '#C4B5FD', 'tertiaryTextColor': '#1A1A2E', 'fontSize': '15px'}}}%%
mindmap
  root((程式語言 Python))
    1-1 I/O 基礎
      print 讓電腦說話
...
## 模組二預告：整理與征服大資料{style="border-top: 0; margin-top: 32px; padding-top: 16px;"}
