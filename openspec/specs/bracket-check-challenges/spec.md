...
<!-- @trace
source: empty-starter-code
updated: 2026-08-07
code:
  - docs/challenge/coupon-combo-quote.md
  - docs/challenge/snack-bar-register.md
  - docs/challenge/magazine-typeset-check.md
  - docs/challenge/prop-box-packing.md
-->