...
- All three `reference_solution` implementations score 20/20 in a cross-origin-isolated browser, the tightest of them finishing an order of magnitude inside the per-testcase deadline (fact W1).
