...
- [x] 4.1 pnpm dev 起站，依 agent-browser SOP 對 V 表具路線檔之 11 條路線（V1-V5／V7-V12，14 次提交；另補測非 V 表之 E3-naive 檔 1 次）逐路線提交、逐筆核對（期望值見 trace-matrix V 表；V6 兩題與 V8 之 011 欄無路線檔，維持 design-probe 並於 spec 明文豁免；驗證「Snack-bar register testcase plan and discrimination duties」「Coupon-stacking testcase plan and discrimination duties」「Score-ladder disposition and co-opted routes」的實測面）；任何偏差即停
