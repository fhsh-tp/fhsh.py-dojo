...
1. ~~**1.61 倍的餘裕是否足夠**~~ → **維護者於 2026-08-13 裁決：可接受，`DEADLINE_MS` 維持 5,000 ms**。裁決當下六條收編路線已全部量畢，上界 3,115 ms 為定案值。餘裕不足時的處置空間仍記錄於〈釘定〉：常數上限約 6,000 ms（受累計硬砍 120 秒約束），餘裕頂多 1.93 倍。
